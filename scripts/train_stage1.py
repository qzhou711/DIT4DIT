...
from configs.config import DataConfig, ModelConfig, Stage1Config, get_suite_data_config, LIBERO_SUITES, GPU_PRESETS, apply_gpu_preset
...
def setup_distributed():
    ...
    if "RANK" in os.environ:
        ...
        # Timeout of 2 h lets rank 0 download the dataset on a fresh machine
        # without other ranks timing out at the first barrier.
